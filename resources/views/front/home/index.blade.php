...
<section class="container mx-auto mt-4 pt-20  sm:border-t border-black  px-8 sm:px-0">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5">
        <div class="col-span-1 border  border-black  border-b-0 sm:border-b sm:border-r-0 p-4 hover:bg-gray-100 transition">
        ...
        <div class="col-span-1 sm:col-start-3 border  border-black border-b-0 sm:border-b sm:border-l-0 p-4 hover:bg-gray-100 transition">
            <h2 class="font-bold text-xl">Highly Costumizable</h2>
            <p class="">
        ...
        <div class="col-span-1 lg:col-start-2 border  border-black border-b-0  sm:border-l-0 border-t-0 lg:border-l p-4 hover:bg-gray-100 transition">
            <h2 class="font-bold text-xl">Highly Costumizable</h2>
            <p class="">
        ...
        <div class="col-span-1 lg:col-start-5  border-t hidden sm:block  border-black p-4">
