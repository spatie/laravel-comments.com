...
<section class="grid grid-cols-5 container mx-auto">
    <div class="col-span-5 inline-grid items-start py-4 grid-cols-5 border-b border-black">
        ...
        <h1 class="col-span-3 text-7xl font-normal uppercase">Laravel</h1>
    </div>
    <div class="col-span-5 inline-grid items-start py-4 grid-cols-5 border-b border-black">
        <h1 class="col-span-3 col-start-2 text-7xl font-bold flex items-end gap-4 uppercase">
            Comments
    ...
    <div class="col-span-5 inline-grid items-start py-4 pb-32 grid-cols-5">
        <p class="col-start-2 col-span-2">A package for laravel. Get a comments section up an running in no time</p>
    </div>
